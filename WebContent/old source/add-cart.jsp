						...
						<div class="row">
							<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
								<div class="section-block" id="basicform">
									<h3 class="section-title">Cart Information</h3>
									<p>Please enter information to add</p>
								</div>
								<div class="card">
									<h5 class="card-header">Adding Cart</h5>
									<div class="card-body">
										<form  action="/HelloServlet/cart/add"	method="post">
											<!-- ID -->
											...
											<div class="form-group">
												...
												<select class="form-control" id="input-select" name="idBuyer">
											...
											<!-- Date -->
											<div class="form-group">
												<label for="inputStatus">Buy Date</label>
												<div class="input-group date" id="datetimepicker1"
													data-target-input="nearest">
													<input type="text" class="form-control datetimepicker-input" name="buyDate"
														data-target="#datetimepicker1" placeholder="dd/MM/yyyy"/>

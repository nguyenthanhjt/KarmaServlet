						...
						<ul class="navbar-nav flex-column">
							...
							<li class="nav-item">
                                ...
                                <div id="submenu-5" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="/HelloServlet/user/list">User List</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="/HelloServlet/product/list">Product List</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="/HelloServlet/categort/list">Category List</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="/HelloServlet/cart/list">Cart List</a>
                                        </li>
				...
				<div class="row">
					...
					<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
						<div class="card">
							...
							<div><a class="btn btn-success" href="/HelloServlet/cart-item/add">Add new</a></div>
							<div class="card-body">
											...
											<c:forEach items="${items }" var="i">
												...
												<th>${i.getCart().getBuyDate() }</th>
													<td><a class="btn btn-success"
														href="/HelloServlet/cart-item/update?uid=${i.id}">Edit</a> | <a
														class="btn btn-danger"
														href="/HelloServlet/cart-item/delete?uid=${i.id}">Delete</a></td>
												</tr>
											</c:forEach>
										</tbody>
										<tfoot>

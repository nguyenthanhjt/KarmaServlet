...
<title>Add Cart Detail</title>
<!-- Bootstrap CSS -->
<link rel="stylesheet"
	href="/HelloSerlvet/assets/vendor/bootstrap/css/bootstrap.min.css">
<link href="/HelloSerlvet/assets/vendor/fonts/circular-std/style.css"
	rel="stylesheet">
<link rel="stylesheet" href="../assets/libs/css/style.css">
<link rel="stylesheet"
	href="/HelloSerlvet/assets/vendor/fonts/fontawesome/css/fontawesome-all.css">
<link rel="stylesheet"
	href="/HelloSerlvet/assets/vendor/datepicker/tempusdominus-bootstrap-4.css" />
<link rel="stylesheet"
	href="/HelloSerlvet/assets/vendor/inputmask/css/inputmask.css" />
</head>
...
<body>
						...
						<ul class="navbar-nav flex-column">
							...
							<li class="nav-item"><a class="nav-link" href="#"
								...
								<div id="submenu-5" class="collapse submenu" style="">
									<ul class="nav flex-column">
										<li class="nav-item"><a class="nav-link"
											href="general-table.html">General Tables</a></li>
										<li class="nav-item"><a class="nav-link"
											href="data-tables.html">Data Tables</a></li>
									</ul>
								</div></li>
						...
						<div class="row">
							<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
								...
								<div class="card">
									...
									<div class="card-body">
										<form  action="/HelloServlet/cart-item/add"	method="post">
											<!-- ID -->
											<div class="form-group">
												<label for="inputText3" class="col-form-label">ID</label>
												 <input	id="id" name="id" type="text" class="form-control" placeholder="No need to enter" readonly="readonly">
											</div>
											<!-- Buyer -->
											<div class="form-group">
												<label for="inputBuyer">Product</label> 
												<select class="form-control" id="input-select" name="product">
													<c:forEach items="${user }" var="u">
														<option value="${u.getAd() }" >${u.getName() }</option>
													</c:forEach>
												</select>
											</div>
											<!-- Status -->
											<div class="form-group">
												<label for="inputStatus">Price</label>
												 <select class="form-control" id="input-select" name="price">
											...
											<div class="form-group">
												...
												<div class="input-group date" id="datetimepicker1"
													...
													<input type="text" class="form-control datetimepicker-input" name="quantity"
														data-target="#datetimepicker1" placeholder="So luong"/>
	...
	<script src="/HelloSerlvet/assets/vendor/bootstrap/js/bootstrap.bundle.js"></script>
	<script src="/HelloSerlvet/assets/vendor/slimscroll/jquery.slimscroll.js"></script>
	<script src="/HelloSerlvet/assets/libs/js/main-js.js"></script>
	<script src="/HelloSerlvet/assets/vendor/inputmask/js/jquery.inputmask.bundle.js"></script>
	<script>
		$(function(e) {
			"use strict";

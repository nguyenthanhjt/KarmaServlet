				...
				<div class="row">
					...
					<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
						<div class="card">
							...
							<div><a class="btn btn-success" href="/HelloServlet/cart/add">Add new</a></div>
							<div class="card-body">
											...
											<c:forEach items="${cartList }" var="c">
												<tr>
													...
													<td><a class="btn btn-success"
														href="/HelloServlet/cart/update?uid=${c.id}">Edit</a> | <a
														class="btn btn-danger"
														href="/HelloServlet/cart/delete?uid=${c.id}">Delete</a></td>
												</tr>
											</c:forEach>
										</tbody>
										<tfoot>

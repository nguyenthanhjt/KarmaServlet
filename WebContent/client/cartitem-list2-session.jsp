...
<body>
		...
		<div class="dashboard-wrapper">
			<div class="container-fluid  dashboard-content">
							...
							<div class="page-breadcrumb">
								<nav aria-label="breadcrumb">
									<ol class="breadcrumb">
										...
										<li class="breadcrumb-item"><a href="#"
											class="breadcrumb-link">List</a></li>
									</ol>
								</nav>
							</div>
						</div>
				...
				<div class="row">
					...
					<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
						<div class="card">
							<h5 class="card-header">Cart Item Detail</h5>
							<div>
								<a class="btn btn-success"
									href="/HelloServlet/client/product-list">Add new</a>
							</div>
							<div class="card-body">
									...
									<table class="table table-striped table-bordered first">
										...
										<tbody>
											<c:forEach items="${sessionScope.cart }" var="i">
												<tr>
													<th>${i.value.id }</th>
													<th>${i.value.cart.id }</th>
													<th>${i.value.getCart().getBuyer().getName() }</th>
													<th>${i.value.getP().getName() }</th>
													<th>${i.value.getQuantity() }</th>
													<th>${i.value.getUnitPrice() }</th>
													<th>${i.value.getCart().getStatus() }</th>
													<th>${i.value.getCart().getBuyDate() }</th>
													<th>${i.value.getQuantity()*i.value.getUnitPrice() }</th>
													<td><a class="btn btn-success"
														href="/HelloServlet/member/update-cart-item?key=${i.key}">Edit</a>
														| <a class="btn btn-danger"
														href="/HelloServlet/member/remove-cart-item?key=${i.key}">Delete</a></td>
												</tr>
											</c:forEach>
										</tbody>
										<tfoot>
								...
								<div>
									<a class="btn btn-success" href="/HelloServlet/member/pay">
										Payment</a>
								</div>
							</div>
						</div>
				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
							Copyright © 2018 JT. All rights reserved. Dashboard by <a
								href="https://colorlib.com/wp/">Nguyen Thanh JT</a>.
						</div>
						<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
	...
	<script
		src="../../../../../cdn.datatables.net/fixedheader/3.1.5/js/dataTables.fixedHeader.min.js"></script>

		...
		<div class="search_input" id="search_input_box">
			<div class="container">
				<form class="d-flex justify-content-between"
					action="/HelloServlet/client/search-product" method="post">
					<input type="text" name="keyword" class="form-control" id="search_input"
					...
					<ul class="main-categories">
						<c:forEach items="${categoryList }" var="c">
							<li class="main-nav-list">
								<a href="/HelloServlet/client/product-list?cateID=${c.id}" aria-expanded="false"aria-controls="fruitsVegetable">
									${c.name}
								</a>
								<!-- <ul class="collapse" id="fruitsVegetable" data-toggle="collapse" aria-expanded="false" aria-controls="fruitsVegetable">
									<c:forEach items="${productList }" var="p">
										<li class="main-nav-list child">
											<a href="/HelloServlet/client/product-detail?productId=${p.id}">${p.name }<span class="number">(13)</span></a>
										</li>
									</c:forEach>
								</ul> -->
							</li>
						...
						<c:forEach items="${productList}" var="p">
							...
							<div class="col-lg-4 col-md-6">
								<div class="single-product">
									<a href="/HelloServlet/client/product-detail?productId=${p.id }">
										<img class="img-fluid" src="/HelloServlet/img?filename=${p.image }" width="263" height="280" alt="${p.name }">
									</a>
									<div class="product-details">
										...
										<div class="prd-bottom">
											...
											<a href="/HelloServlet/client/add-to-cart?productId=${p.id }"
											...
											</a> <a href="/HelloServlet/client/product-detail?productId=${p.id }" class="social-info"> <span

						...
						<div class="card">
							...
							<div>
								<a class="btn btn-success"
									href="/HelloServlet/admin/cart-item/add">Add new</a>
							</div>
							<div class="card-body">
											...
											<c:forEach items="${sessionScope.cart }" var="i">
												<tr>
													...
													<td><a class="btn btn-success"
														href="/HelloServlet/remove-cart-item?key=${i.key}">Edit</a>
														| <a class="btn btn-danger"
														href="/HelloServlet/remove-cart-item?key=${i.key}">Delete</a></td>
												</tr>
											</c:forEach>
										</tbody>
										<tfoot>

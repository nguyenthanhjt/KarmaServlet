...
<body>
								...
								<div id="submenu-1" class="collapse submenu" style="">
									<ul class="nav flex-column">
										<li class="nav-item"><a class="nav-link"
											href="index.html" data-toggle="collapse"
							...
							<li class="nav-item"><a class="nav-link" href="#"
								...
								<div id="submenu-2" class="collapse submenu" style="">
									<ul class="nav flex-column">
										...
										<li class="nav-item"><a class="nav-link"
											href="listgroup.html">List Group</a></li>
										<li class="nav-item"><a class="nav-link"
											href="typography.html">Typography</a></li>
										<li class="nav-item"><a class="nav-link"
											href="accordions.html">Accordions</a></li>
										<li class="nav-item"><a class="nav-link" href="tabs.html">Tabs</a>
										</li>
									</ul>
								</div></li>
							<li class="nav-item"><a class="nav-link" href="#"
								...
								<div id="submenu-3" class="collapse submenu" style="">
									<ul class="nav flex-column">
										<li class="nav-item"><a class="nav-link"
											href="chart-c3.html">C3 Charts</a></li>
										<li class="nav-item"><a class="nav-link"
											href="chart-chartist.html">Chartist Charts</a></li>
										<li class="nav-item"><a class="nav-link"
											href="chart-charts.html">Chart</a></li>
										<li class="nav-item"><a class="nav-link"
											href="chart-morris.html">Morris</a></li>
										<li class="nav-item"><a class="nav-link"
											href="chart-sparkline.html">Sparkline</a></li>
										<li class="nav-item"><a class="nav-link"
											href="chart-gauge.html">Guage</a></li>
									</ul>
								</div></li>
							<li class="nav-item "><a class="nav-link" href="#"
								data-toggle="collapse" aria-expanded="false"
								...
								<div id="submenu-4" class="collapse submenu" style="">
									<ul class="nav flex-column">
										...
										<li class="nav-item"><a class="nav-link"
											href="form-validation.html">Parsely Validations</a></li>
										<li class="nav-item"><a class="nav-link"
											href="multiselect.html">Multiselect</a></li>
									</ul>
								</div></li>
							<li class="nav-item"><a class="nav-link" href="#"
								data-toggle="collapse" aria-expanded="false"
								...
								<div id="submenu-5" class="collapse submenu" style="">
									<ul class="nav flex-column">
										<li class="nav-item"><a class="nav-link"
											href="/HelloServlet/admin/user/list">User List</a></li>
										<li class="nav-item"><a class="nav-link"
											href="/HelloServlet/admin/product/list">Product List</a></li>
										<li class="nav-item"><a class="nav-link"
											href="/HelloServlet/admin/categort/list">Category List</a></li>
										<li class="nav-item"><a class="nav-link"
											href="/HelloServlet/admin/cart/list">Cart List</a></li>
										<li class="nav-item"><a class="nav-link"
											href="/HelloServlet/admin/admin/cart-item/list">Cart Item
												List</a></li>
							...
							<li class="nav-item"><a class="nav-link" href="#"
								...
								<div id="submenu-6" class="collapse submenu" style="">
									<ul class="nav flex-column">
										...
										<li class="nav-item"><a class="nav-link"
											href="blank-page.html">Blank Page</a></li>
										<li class="nav-item"><a class="nav-link"
											href="blank-page-header.html">Blank Page Header</a></li>
										<li class="nav-item"><a class="nav-link"
											href="login.html">Login</a></li>
										<li class="nav-item"><a class="nav-link"
											href="404-page.html">404 page</a></li>
										<li class="nav-item"><a class="nav-link"
											href="sign-up.html">Sign up Page</a></li>
										<li class="nav-item"><a class="nav-link"
											href="forgot-password.html">Forgot Password</a></li>
										<li class="nav-item"><a class="nav-link"
											href="pricing.html">Pricing Tables</a></li>
										<li class="nav-item"><a class="nav-link"
											href="timeline.html">Timeline</a></li>
										<li class="nav-item"><a class="nav-link"
											href="calendar.html">Calendar</a></li>
										<li class="nav-item"><a class="nav-link"
											href="sortable-nestable-lists.html">Sortable/Nestable
												List</a></li>
										<li class="nav-item"><a class="nav-link"
											href="widgets.html">Widgets</a></li>
										<li class="nav-item"><a class="nav-link"
											href="media-object.html">Media Objects</a></li>
										<li class="nav-item"><a class="nav-link"
											href="cropper-image.html">Cropper</a></li>
										<li class="nav-item"><a class="nav-link"
											href="color-picker.html">Color Picker</a></li>
									</ul>
								</div></li>
							<li class="nav-item"><a class="nav-link" href="#"
								data-toggle="collapse" aria-expanded="false"
								...
								<div id="submenu-7" class="collapse submenu" style="">
									<ul class="nav flex-column">
										...
										<li class="nav-item"><a class="nav-link"
											href="email-details.html">Email Detail</a></li>
										<li class="nav-item"><a class="nav-link"
											href="email-compose.html">Email Compose</a></li>
										<li class="nav-item"><a class="nav-link"
											href="message-chat.html">Message Chat</a></li>
									</ul>
								</div></li>
							<li class="nav-item"><a class="nav-link" href="#"
								data-toggle="collapse" aria-expanded="false"
								...
								<div id="submenu-8" class="collapse submenu" style="">
									<ul class="nav flex-column">
										<li class="nav-item"><a class="nav-link"
											href="icon-fontawesome.html">FontAwesome Icons</a></li>
										<li class="nav-item"><a class="nav-link"
											href="icon-material.html">Material Icons</a></li>
										<li class="nav-item"><a class="nav-link"
											href="icon-simple-lineicon.html">Simpleline Icon</a></li>
										<li class="nav-item"><a class="nav-link"
											href="icon-themify.html">Themify Icon</a></li>
										<li class="nav-item"><a class="nav-link"
											href="icon-flag.html">Flag Icons</a></li>
										<li class="nav-item"><a class="nav-link"
											href="icon-weather.html">Weather Icon</a></li>
									</ul>
								</div></li>
							<li class="nav-item"><a class="nav-link" href="#"
								data-toggle="collapse" aria-expanded="false"
								...
								<div id="submenu-9" class="collapse submenu" style="">
									<ul class="nav flex-column">
										<li class="nav-item"><a class="nav-link"
											href="map-google.html">Google Maps</a></li>
										<li class="nav-item"><a class="nav-link"
											href="map-vector.html">Vector Maps</a></li>
									</ul>
								</div></li>
							<li class="nav-item"><a class="nav-link" href="#"
								data-toggle="collapse" aria-expanded="false"
										...
										<nav aria-label="breadcrumb">
											<ol class="breadcrumb">
												<li class="breadcrumb-item"><a href="#"
													class="breadcrumb-link">Cart</a></li>
												<li class="breadcrumb-item"><a href="#"
													class="breadcrumb-link">Add</a></li>
											</ol>
										</nav>
									</div>
								</div>
						...
						<div class="row">
							<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
								<div class="section-block" id="basicform">
									<h3 class="section-title">Cart Detail Information</h3>
									<p>Please enter information to add</p>
								</div>
								<div class="card">
									<h5 class="card-header">Adding Cart Detail</h5>
									<div class="card-body">
										<form action="/HelloServlet/admin/cart-item/add" method="post">
											<!-- ID -->
											<div class="form-group">
												<label for="inputText3" class="col-form-label">ID</label> <input
													id="id" name="id" type="text" class="form-control"
													placeholder="No need to enter" readonly="readonly"
													value="${cartItem.id }">
											</div>
											<!-- Cart -->
											<div class="form-group">
												<label for="inputBuyer">Cart </label> <select
													class="form-control" id="input-select" name="cartId">
													<c:forEach items="${carts }" var="c">
														<c:choose>
															<c:when test="${c.getId()==cartItem.getCart().getId() }">
																<option value="${c.id}" selected>ID: ${c.id }|
																	Buyer: ${c.getBuyer().getName() }|Buy date:
																	${c.buyDate} |Status: ${c.status }</option>
															</c:when>
															<c:otherwise>
																<option value="${c.id}">ID: ${c.id }| Buyer:
																	${c.getBuyer().getName() }|Buy date: ${c.buyDate}
																	|Status: ${c.status }</option>
															</c:otherwise>
														</c:choose>
													</c:forEach>
												</select>
											...
											<!-- Product -->
											<div class="form-group">
												<label for="inputBuyer">Product</label> <select
													class="form-control" id="input-select" name="productId">
													<c:forEach items="${products }" var="p">
														<c:choose>
															<c:when test="${p.id==cartItem.getP().getId() }">
											...
											<!-- Price -->
											<div class="form-group">
												<label for="inputStatus">Price</label> <input id="id"
													name="price" type="text" class="form-control"
													placeholder="No need to enter" readonly="readonly"
													value="${cartItem.getUnitPrice() }">
											</div>
											<!-- Quantity -->
											<div class="form-group">
												...
												<div class="input-group date" id="datetimepicker1"
													...
													<input id="quantity" name="quantity" type="text"
														class="form-control" placeholder="No need to enter"
	...
	<!-- ============================================================== -->
	<!-- Optional JavaScript -->
	<script src="/HelloSerlvet/assets/vendor/jquery/jquery-3.3.1.min.js"></script>
	<script
		src="/HelloSerlvet/assets/vendor/bootstrap/js/bootstrap.bundle.js"></script>
	<script
		src="/HelloSerlvet/assets/vendor/slimscroll/jquery.slimscroll.js"></script>
	<script src="/HelloSerlvet/assets/libs/js/main-js.js"></script>
	<script
		src="/HelloSerlvet/assets/vendor/inputmask/js/jquery.inputmask.bundle.js"></script>
	<script>
		$(function(e) {
			"use strict";

							...
							<li class="nav-item"><a class="nav-link" href="#"
								...
								<div id="submenu-5" class="collapse submenu" style="">
									<ul class="nav flex-column">
										...
										<li class="nav-item"><a class="nav-link"
											href="/HelloServlet/admin/category/list">Category List</a></li>
										<li class="nav-item"><a class="nav-link"
				...
				<div class="row">
					...
					<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
						<div class="card">
							...
							<div>
								<a class="btn btn-success" href="/HelloServlet/admin/cart/add">Add
									new</a>
							</div>
							<div class="card-body">
									...
									<table class="table table-striped table-bordered first">
										...
										<tbody>
											<c:forEach items="${cartList }" var="c">
												<tr>
													<td>${c.id }</td>
													<td>${c.getBuyer().getName() }</td>
													<td>${c.status }</td>
													<td>${c.buyDate }</td>
													<td><a class="btn btn-success"
														href="/HelloServlet/admin/cart/update?uid=${c.id}">Edit</a>
														| <a class="btn btn-danger"
														href="/HelloServlet/admin/cart/delete?uid=${c.id}">Delete</a>
														| <a class="btn btn-danger"
														href="/HelloServlet/cart-item/detail?cartId=${c.id}">Detail</a>
													</td>
												</tr>
											</c:forEach>
										</tbody>

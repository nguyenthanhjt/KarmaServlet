			...
			<div class="col-md-3 col-sm-6">
				<ul class="list-group">
					...
					<li class="list-group-item"><a class="btn btn-success"
						href="http://localhost:8081/HelloServlet/category/add">Add
							Category</a></li>
				</ul>
			</div>
				...
				<table class="table table-bordered">
					...
					<tr>
						...
						<td><a class="btn btn-success"
							href="/HelloServlet/admin/product/list2?uid=<%=cate.getId()%>">List</a>
							|</td>
						<td><a class="btn btn-success"
							href="/HelloServlet/category/edit?uid=<%=cate.getId()%>">Edit</a>
							| <a class="btn btn-danger"
							href="/HelloServlet/category/delete?uid=<%=cate.getId()%>">Delete</a></td>
					</tr>
					<%
						}
					%>
